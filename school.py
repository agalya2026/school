...
firstw = Tk()
firstw.title("JB SCHOOL of institution")
firstw.geometry("1600x1000+0+0")
label = Label(text="JB SCHOOL of institution", font=("times new roman", 35), bg="MediumOrchid2")
...
def second():
    global secondw
    secondw = Tk()
    secondw.title("JB SCHOOL of institution")
    ...
    mainlabel = Label(secondw, text="JB SCHOOL of institution", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
    ...
    viewenquiry = Button(secondw, width=13, font=("arial", 20), text="VIEW ENQUIRY", bg="MediumOrchid2",
                         command=viewenquiry2)
    viewenquiry.place(x=740, y=480)
    viewenquiry1 = Button(secondw, width=13, font=("arial", 20), text="STUDENT ID ", bg="MediumOrchid2",
                          command=studentid)
...
def login():
    if user.get() == "agalya" and user3.get() == "12345":
        second()
        distroy()
...
def root():
    ...
    root.title("JB SCHOOL of institution")
    global entry1
    global entry2
    global entry3
    global entry4
